...
const importConfig = () => {
  ...
  const dataUpdateLicense = {
    cmd: {
      ...
      payload: {
        cmdType: cmdTypes.updateFirmwareMCU,
      },
    },
    fw: fileImport.value,
  };
...
<template>
  <div class="mb-5">
    ...
    <el-descriptions class="mt-3" :column="1" :size="size" border>
      <el-descriptions-item align="center">
        <template #label>
          <div class="cell-item">Version</div>
        </template>
        {{ mainStore.gatewayInfo.mcuFirmware }}
      </el-descriptions-item>
    </el-descriptions>
  </div>
  <div>
    <el-link type="primary" disabled>Update MCU Firmware</el-link>
    <el-upload
      ref="upload"
